...
export const CommentsList = ({ commentsData, id }) => {
  ...
  return (
    <div>
      {
        isComments && <div className="w-full  h- overflow-hidden md:hidden block">
        <div className="w-11/12 ">
          <div className="flex  md:flex-row mt-4 items-start md:items-center">
            ...
            {isReplies && showReplies && (
              <div className="mt-4">
                {replies.map((reply) => (
                  <div
                    key={reply.id}
                    className="flex flex-col md:flex-row mt-4 items-start md:items-center"
                  >
                    <div className="flex-shrink-0">
                      <img
                        className="mr-3 w-10 h-10 rounded-full"
                    ...
                    <div className="flex flex-col flex-grow">
                      <div className="flex items-center">
                        ...
                        <p className="text-xs ml-2">
                          {formatPublishedDate(reply.snippet.publishedAt)}
                        </p>
                      </div>
