  ...
  return (
    <div className="fixed top-0 left-0 w-full h-22 bg-white text-white px-4 pt-1 z-50">
      <div className="grid grid-flow-col gap-2 mx-2 px-2 overflow-hidden">
        ...
        <div className="flex flex-col col-span-10 items-center justify-center">
          <div className=" w-6/12">
            <div className="flex justify-center w-full">
              <input
                placeholder="Search"
                className="border rounded-l-full w-full h-10 px-8 text-black focus:outline-gray-300 focus:shadow-inner"
                type="text"
                name="search"
                id=""
              ...
              />
              <button className="rounded-r-full border h-10 px-8">
                <img
                  className="w-5 h-5"
            ...
            {showSuggestions === true ? (
              <div className="flex justify-start">
                <div className=" mt-1 shadow-2xl border border-gray-200 rounded-xl absolute bg-white w-[38rem]">
                  <ul className="my-4">
